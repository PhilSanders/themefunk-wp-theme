...
/* Netfunk Front Page Featured 'Pages' Widget */

class Netfunk_Featured_Pages extends WP_Widget {

	public function Netfunk_Featured_Pages(){
	...
	public function widget( $args, $instance ) {
		...
		$offset =  (!empty($instance[ 'pages_offset' ]) ? $instance[ 'pages_offset' ] : 0 );
...
<?php 
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['pages_per_page'] = ( ! empty( $new_instance['pages_per_page'] ) ) ? strip_tags( $new_instance['pages_per_page'] ) : '6';
		$instance['pages_featured_id'] = ( ! empty( $new_instance['pages_featured_id'] ) ) ? strip_tags( $new_instance['pages_featured_id'] ) : '';
		$instance['pages_grid_size'] = ( ! empty( $new_instance['pages_grid_size'] ) ) ? strip_tags( $new_instance['pages_grid_size'] ) : '2';
...
/* Netfunk Front Page Featured 'Posts' Widget */
